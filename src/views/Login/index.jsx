              ...
              <Grid container flexDirection="column">
                <Grid item>
                  <p className={classes.nav}>
                    ...
                    <span className={classes.brand}>Login</span>
                  </p>
                </Grid>
                <Grid item>
                  <p className={classes.titleNav}>
                    Login <span className={classes.brand}>Form</span>
                  </p>
                </Grid>
              </Grid>
            </Grid>
            ...
            >
              <Grid container spacing={2} className={classes.form}>
                <h3 className={classes.title}>
                  Login <span className={classes.brand}>Now</span>
                </h3>
                <Grid item xs={12}>
                  <BaseField
                    name="email"
